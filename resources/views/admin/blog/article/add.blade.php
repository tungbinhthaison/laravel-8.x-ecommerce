...
<div class="container-fluid">
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form method="POST" action="/admin/blog/article/store">
                @csrf
                <div class="form-row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label class="small mb-1">Category</label>
                            <select class="custom-select" name="select_category" id="selectArticle">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control py-4" name="input_short_content" id="inputShortContent" type="text" placeholder="Enter last name" />
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-checkbox">
                                <input class="custom-control-input" id="cb_publish_password" type="checkbox" name="cb_publish_password" />
